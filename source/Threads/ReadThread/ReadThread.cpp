...
void __fastcall ReadThread::Execute()
{
	while(!Terminated)
	{
		// æäàòü êîãäà áóäóò ïîäãîòîâëåíû äàííûå ê ñëåä àíàëèçó
